...
6. The folder "Predictions" contains the actual predictions of the best-performing logistic model (for the micro-level, Q1), both for consecutive and random splits. Use the "global_id" column to match the predictions with the other parts of the dataset.
