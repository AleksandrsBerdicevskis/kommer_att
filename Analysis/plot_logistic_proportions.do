...
filefilter tochange.svg totransform.svg, from(`"stroke-width:5.24"') to(`"stroke-width:5.00; opacity:.75"') replace 
		
capture erase figure3.png
			
*Use inkscape to transform svg into png
!inkscape "`dir'/totransform.svg" --without-gui --export-dpi=1800 --export-png  "`dir'/figure3.png"                                                
