...
save logistic_overwiew, replace

local till = _N
foreach training_type in  non_consecutive consecutive {
		forvalues i = 1/`till' {
			use logistic_overwiew, clear
			...
			*Same for distance to att_words
			...
			keep global_id outcome year month M_month subject voice att_before att_after distance_to_att_words inf_length genre test verb_lemma
